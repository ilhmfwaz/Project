...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try{
           sql = "SELECT * FROM admin WHERE id_admin='"+ userField.getText()+"' AND pw_admin='"+pwField.getText()+"'";
           rs = st.executeQuery(sql);
           if(rs.next()){
               if(userField.getText().equals(rs.getString("id_admin")) && pwField.getText().equals(rs.getString("pw_admin"))){
